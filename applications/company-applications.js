document.addEventListener("DOMContentLoaded", () => {
  ...
  // Check if user is logged in via OAuth and is a company
  if (!currentUser || !currentUser.provider || currentUser.role !== "company") {
  ...
  function renderApplicants(applicants) {
    ...
    applicantsContainer.innerHTML = applicants
      .map(
        (applicant) => `
            <div class="applicant-card glassmorphism status-${applicant.status}">
                <div class="applicant-header">
                    <div class="applicant-avatar">
                        <img src="../assets/profile-icon.svg" alt="${applicant.student.name}">
                    </div>
  ...
  window.sendMessage = (studentId) => {
    ...
    showNotification(
      "Message feature will be implemented in the chat module",
      "info",
    );
  };
